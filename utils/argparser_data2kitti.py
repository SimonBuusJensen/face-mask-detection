...
class argparser_data2kitti():
    def __init__(self):
        ...
        self.parser.add_argument('--tlt-input-dims_width', dest='tlt_input_dims_width', default=480,
                                 help = 'TLT input dimensions', type = int)
        self.parser.add_argument('--tlt-input-dims_height', dest='tlt_input_dims_height', default=272,
                                 help='TLT input dimensions', type=int)
